#
#
set terminal postscript eps noenhanced defaultplex    leveldefault color colortext    dashed dashlength 3.0 linewidth 1.0 butt    palfuncparam 2000,0.003    "Helvetica" 16
set output "../eps_s/neisseria_5_Q0.eps"
...
set label at 423-10, 0.2 "L1" front font "Helvetica,12"

set obj rect from 516, -1 to 536,1
set label at 516-10, 0.2 "L2" front font "Helvetica,12"

set obj rect from 645, -1 to 761,1
set label at 645+30, 0.2 "L3" front font "Helvetica,12"

set obj rect from 864, -1 to 902,1
set label at 864-5, 0.2 "L4" front font "Helvetica,12"

set obj rect from 1023, -1 to 1172,1
set label at 1023+40, 0.2 "L5" front font "Helvetica,12"

set obj rect from 1260, -1 to 1292,1
set label at 1260-5, 0.2 "L6" front font "Helvetica,12"

set obj rect from 1380, -1 to 1454,1
set label at 1380+15, 0.2 "L7" front font "Helvetica,12"

set obj rect from 1557, -1 to 1586,1
set label at 1557-5, 0.2 "L8" front font "Helvetica,12"

set obj rect from 1707, -1 to 1775,1
set label at 1707+10, 0.2 "L9" front font "Helvetica,12"

set obj rect from 1845, -1 to 1925,1
set label at 1845+5, 0.2 "L10" front font "Helvetica,12"

set obj rect from 2013, -1 to 2033,1
set label at 2013-30, 0.2 "L11" front font "Helvetica,12"
...
set trange [0:1]
#
plot  "../files/q_func_neisseria_5.csv" using ($2+2):6 title 'Q0 = log (1 + D(X,Y) - V(X))' with lines ls 3, const,t notitle with lines ls 8
#
