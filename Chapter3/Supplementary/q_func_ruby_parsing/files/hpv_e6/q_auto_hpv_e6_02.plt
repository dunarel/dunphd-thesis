...
set output "q_auto_hpv_e6_02.eps"
...
# ,"f_1_2_3_4_w9.csv" using 2:($4) axes x1y1 title 'Q2Auto' with lines ls 4 \
     # ,"f_1_2_3_4_w9.csv" using 2:($5) axes x1y1 title 'Q3Auto' with lines ls 5 \
     # ,"f_1_2_3_4_w9.csv" using 2:($6) axes x1y1 title 'Q3Auto' with lines ls 6 \
      #,"q_func_feta.csv" using 2:($23) axes x1y1 title 'QAuto' with lines ls 4 \
      #,"q_func_feta.csv" using 2:($23*$27) axes x1y1 title 'QAuto*CorRand' with lines ls 5 \
