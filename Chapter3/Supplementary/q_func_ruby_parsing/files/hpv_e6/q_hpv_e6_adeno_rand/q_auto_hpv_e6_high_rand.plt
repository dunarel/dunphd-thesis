...
set output "q_hpv_e6_squam_rand.eps"
...
set xtics 100 nomirror out border
set mxtics 10
set ytics  nomirror out border
set mytics 10
...
set style line 4 lt 4 lc rgb "blue" lw 4
set style line 5 lt 1 lc rgb "violet" lw 3

#set style fill pattern 2
#set style fill solid 1.0 noborder


plot  "f_1_2_3_4_w9_hpv_e6_high_rand.csv" using 2:( abs($7-$6)> 0.01 ? $7 : $7) with lines ls 4 axes x1y1 title "ARI(SQUAM)*max(Q_1\',Q_2\')"  \
      ,"f_1_2_3_4_w9_hpv_e6_high_rand.csv" using 2:( abs($8-$6)> 0.01 ? $8 : $7) with lines ls 5 axes x1y1 title "ARI(SQUAM)*Q_3\'"  \
      ,"f_1_2_3_4_w9_hpv_e6_high_rand.csv" using 2:($6) with lines ls 3 axes x1y1 title "ARI(SQUAM)*Q_4\'"
