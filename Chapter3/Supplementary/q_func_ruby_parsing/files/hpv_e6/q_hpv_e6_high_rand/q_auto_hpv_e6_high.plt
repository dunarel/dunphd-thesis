...
set output "q_auto_hpv_e6_high.eps"
...
set yrange [-0.04:0.06] #noreverse nowriteback
...
plot  "f_1_2_3_4_w9_hpv_e6_high.csv" using 2:( abs($7-$6)> 0.01 ? $7 : $7) with lines ls 4 axes x1y1 title "max(Q_1,Q_2)"  \
      ,"f_1_2_3_4_w9_hpv_e6_high.csv" using 2:( abs($8-$6)> 0.01 ? $8 : $7) with lines ls 5 axes x1y1 title "Q_3"  \
      ,"f_1_2_3_4_w9_hpv_e6_high.csv" using 2:($6) with lines ls 3 axes x1y1 title "Q_4"
