...
class AdnE6
  ...
  def initialize()
    ...
    @seqs_file = @data_dir + 'files/nucl/orig_hpv_adn_E6.fasta'
    @msa_file = @data_dir + 'files/nucl/msa_hpv_adn_E6.fasta'
    #same identifiers
    @ident_x_file = @data_dir  + 'files/nucl/x_ident_16_18.csv'
    @q_func_csv = @data_dir + 'files/nucl/q_func_hpv_adn_E6.csv'
    @gnuplot_plt = @data_dir + 'files/nucl/q_func_hpv_adn_E6.plt'
    @gnuplot_eps = @data_dir + 'files/nucl/q_func_hpv_adn_E6.eps'
    @gnuplot_png = @data_dir + 'files/nucl/q_func_hpv_adn_E6.png'
  end
