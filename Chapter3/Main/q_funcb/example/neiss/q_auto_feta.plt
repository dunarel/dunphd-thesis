...
plot  "f_1_2_3_4_w9.csv" using 2:( abs($7-$6)> 0.01 ? $7 : $7) with lines ls 4 lc rgb "red" axes x1y1 title "max(Q_1\',Q_2\')"  \
      ,"f_1_2_3_4_w9.csv" using 2:( abs($8-$6)> 0.01 ? $8 : $7) with lines ls 5 lc rgb "blue" axes x1y1 title "Q_3\'"  \
      ,"f_1_2_3_4_w9.csv" using 2:($6) with lines ls 3 lc rgb "violet" axes x1y1 title "Q_4\'" \
