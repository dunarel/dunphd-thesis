...
Its Ruby wrapper [Chapter3/Supplementary/q_func_jruby_ba](Chapter3/Supplementary/q_func_jruby_ba) additionnaly contains code to extract Neisseria frpB outer membrane protein loops coordinates.
