...
using [HGT-Detection, Complete Transfers](http://www.trex.uqam.ca/index.php?action=hgt) 
and [HGT-Detection, Partial Transfers](http://www.trex.uqam.ca/index.php?action=hgt_partial&project=trex).
