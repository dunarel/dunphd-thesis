...
public class PalTiming1 {
    ...
    /**
     * @return the fdrExpMeanRate
     */
    public double getFdrExpMeanRate() {
        return fdrExpMeanRate;
    }

    /**
     * @return the fdrExpSdRate
     */
    public double getFdrExpSdRate() {
        return fdrExpSdRate;
    }
    
    /**
     * @return the fdrEstimateMeanlog
     */
    public double getFdrEstimateMeanlog() {
        return fdrEstimateMeanlog;
    }

    /**
     * @return the fdrEstimateSdlog
     */
    public double getFdrEstimateSdlog() {
        return fdrEstimateSdlog;
    }

    /**
     * @return the fdrSdMeanlog
     */
    public double getFdrSdMeanlog() {
        return fdrSdMeanlog;
    }

    /**
     * @return the fdrSdSdlog
     */
    public double getFdrSdSdlog() {
        return fdrSdSdlog;
    }
