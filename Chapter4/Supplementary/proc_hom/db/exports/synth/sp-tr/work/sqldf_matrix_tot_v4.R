...
select tot90_df.x,
       ...
       tot90_df.val
from tot90_df
 join gn_df on gn_df.x = tot90_df.x and
               gn_df.y = tot90_df.y
where gn_df.val > 6
order by tot90_df.val desc
limit 10
")
...
select tot75_df.x,
       ...
       tot75_df.val
from tot75_df
 join gn_df on gn_df.x = tot75_df.x and
               gn_df.y = tot75_df.y
where gn_df.val > 6
order by tot75_df.val desc
limit 10
")
...
select tot50_df.x,
       ...
       tot50_df.val
from tot50_df
 join gn_df on gn_df.x = tot50_df.x and
               gn_df.y = tot50_df.y
where gn_df.val > 6
order by tot50_df.val desc
limit 10
")
