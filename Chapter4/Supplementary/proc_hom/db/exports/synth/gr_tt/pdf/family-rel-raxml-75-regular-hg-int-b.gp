...
set output "family-rel-raxml-75-regular-hg-int-b.pdf"
...
set object 1 rect from (1-0.3),0             to (1+0.3),0.000000 fc rgb "#5ef1f2" fillstyle solid 1 lw 2 
set object 2 rect from (1-0.3),(0.000000) to (1+0.3),(0.000000) fc rgb "#5ef1f2" fillstyle solid 0.5 lw 2 
# 
set object 3 rect from (2-0.3),0             to (2+0.3),0.000000 fc rgb "#00998f" fillstyle solid 1 lw 2 
set object 4 rect from (2-0.3),(0.000000) to (2+0.3),(0.000000) fc rgb "#00998f" fillstyle solid 0.5 lw 2 
# 
