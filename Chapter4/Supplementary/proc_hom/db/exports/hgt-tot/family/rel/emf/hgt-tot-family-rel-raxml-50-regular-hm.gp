...
set output "hgt-tot-family-rel-raxml-50-regular-hm.emf"
...
set cblabel  "Complete and Partial HGTs, 50 \% confidence " offset +4.5 ,1 font ",20"
...
plot '../dat/hgt-tot-family-rel-raxml-50-regular-hm.dat' using 3:1:5:x2ticlabel(4):yticlabel(2) with image
...
set label 2 "100 %" font "Verdana,14" at 70,-0.9 tc ls 1
...
plot '../dat/hgt-tot-family-rel-raxml-50-regular-hm.daty' using (0):($1):(100):(0) with vector nohead ls 1 , \
     '../dat/hgt-tot-family-rel-raxml-50-regular-hm.daty' using (0):($1-.25):(0):(.5) with vector nohead ls 2, \
     '../dat/hgt-tot-family-rel-raxml-50-regular-hm.daty' using (100):($1-.25):(0):(.5) with vector nohead ls 2

plot '../dat/hgt-tot-family-rel-raxml-50-regular-hm.daty' using (100*$2/100):($1):(16):(0.21) with boxxyerrorbars ls 4 fs solid
#white
plot '../dat/hgt-tot-family-rel-raxml-50-regular-hm.daty' using (100*$3/100):($1):(16):(0.21) with boxxyerrorbars ls 5 fs solid
...
set label 2 "100 %" font "Verdana,14" at -2.5,105 tc ls 1
set arrow 1 from -0.5,-10  to -0.5,102  as 4

set datafile separator "\t"


plot '../dat/hgt-tot-family-rel-raxml-50-regular-hm.datx' using ($1):(0):(0):(100) with vector nohead ls 1 , \
     '../dat/hgt-tot-family-rel-raxml-50-regular-hm.datx' using ($1-.25):(0):(.5):(0) with vector nohead ls 2, \
     '../dat/hgt-tot-family-rel-raxml-50-regular-hm.datx' using ($1-.25):(100):(.5):(0) with vector nohead ls 2


plot '../dat/hgt-tot-family-rel-raxml-50-regular-hm.datx' using ($1):(100*$2/100):(0.21):(16) with boxxyerrorbars ls 4 fs solid
#white
plot '../dat/hgt-tot-family-rel-raxml-50-regular-hm.datx' using ($1):(100*$3/100):(0.21):(16) with boxxyerrorbars ls 5 fs solid
