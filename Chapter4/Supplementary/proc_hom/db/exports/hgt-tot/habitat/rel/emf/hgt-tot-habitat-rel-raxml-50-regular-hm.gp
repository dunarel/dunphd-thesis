...
set output "hgt-tot-habitat-rel-raxml-50-regular-hm.emf"
...
set cblabel "Complete and Partial HGTs, 50 \% confidence " offset +4.5 ,+2.2 font ",24"
...
plot '../dat/hgt-tot-habitat-rel-raxml-50-regular-hm.dat' using 3:1:5:x2ticlabel(4):yticlabel(2) with image
...
plot '../dat/hgt-tot-habitat-rel-raxml-50-regular-hm.daty' using (0):($1):(100):(0) with vector nohead ls 1 , \
     '../dat/hgt-tot-habitat-rel-raxml-50-regular-hm.daty' using (0):($1-.20):(0):(.4) with vector nohead ls 2, \
     '../dat/hgt-tot-habitat-rel-raxml-50-regular-hm.daty' using (100):($1-.20):(0):(.4) with vector nohead ls 2

plot '../dat/hgt-tot-habitat-rel-raxml-50-regular-hm.daty' using (100*$2/100):($1):(15):(0.15) with boxxyerrorbars ls 4 fs solid
#white
plot '../dat/hgt-tot-habitat-rel-raxml-50-regular-hm.daty' using (100*$3/100):($1):(15):(0.15) with boxxyerrorbars ls 5 fs solid
...
plot '../dat/hgt-tot-habitat-rel-raxml-50-regular-hm.datx' using ($1):(0):(0):(100) with vector nohead ls 1 , \
     '../dat/hgt-tot-habitat-rel-raxml-50-regular-hm.datx' using ($1-.20):(0):(.4):(0) with vector nohead ls 2, \
     '../dat/hgt-tot-habitat-rel-raxml-50-regular-hm.datx' using ($1-.20):(100):(.4):(0) with vector nohead ls 2


plot '../dat/hgt-tot-habitat-rel-raxml-50-regular-hm.datx' using ($1):(100*$2/100):(0.15):(15) with boxxyerrorbars ls 4 fs solid
#white
plot '../dat/hgt-tot-habitat-rel-raxml-50-regular-hm.datx' using ($1):(100*$3/100):(0.15):(15) with boxxyerrorbars ls 5 fs solid
