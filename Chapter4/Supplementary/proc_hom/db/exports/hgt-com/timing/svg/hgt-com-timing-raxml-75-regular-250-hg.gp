...
set output "hgt-com-timing-raxml-75-regular-250-hg.svg"
...
set title "Complete horizontal gene transfer relative frequency - Bins of 250 My"
...
#sw(x,S)=1/(x*x*S)
#plot "/root/devel/proc_hom/db/exports/hgt-com/timing/csv/hgt-com-timing-raxml-75-regular-all-med-250.csv" using 1:($2):(sw($2,100)) smooth csplines ls 1 title 'TreePL', \

plot "/root/devel/proc_hom/db/exports/hgt-com/timing/csv/hgt-com-timing-raxml-75-regular-all-med-250.csv" using 1:($2):(1.0) smooth acsplines ls 1 title 'TreePL', \
       ...
       "/root/devel/proc_hom/db/exports/hgt-com/timing/csv/hgt-com-timing-raxml-75-regular-all-med-250.csv" using 1:($3):(1.0) smooth acsplines ls 3 title 'B.E.A.S.T.', \
