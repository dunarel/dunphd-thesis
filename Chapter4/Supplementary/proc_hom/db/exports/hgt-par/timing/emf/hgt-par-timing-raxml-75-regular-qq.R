...
hgt_com_treepl = read.csv("../csv/hgt-par-timing-raxml-75-regular-treepl-med.csv")
hgt_com_beast = read.csv("../csv/hgt-par-timing-raxml-75-regular-beast-med.csv")
...
emf(file = "hgt-par-timing-raxml-75-regular-qq.emf", width = 5, height = 5,
    bg = "transparent", fg = "black", pointsize = 10,
    family = "Helvetica", custom.lty = FALSE)

qs = qqplot(hgt_com_beast$med_wg_per_wg, hgt_com_treepl$med_wg_per_wg, pch = 1, lwd=1,  col = "darkblue", main = "Overall HGT time Q-Q Plot", xlab="B.E.A.S.T.", ylab="TreePL");
