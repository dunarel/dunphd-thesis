...
set output "hgt-par-family-rel-raxml-75-regular-hm.emf"
...
plot '../dat/hgt-par-family-rel-raxml-75-regular-hm.dat' using 3:1:5:x2ticlabel(4):yticlabel(2) with image
...
plot '../dat/hgt-par-family-rel-raxml-75-regular-hm.daty' using (0):($1):(100):(0) with vector nohead ls 1 , \
     '../dat/hgt-par-family-rel-raxml-75-regular-hm.daty' using (0):($1-.25):(0):(.5) with vector nohead ls 2, \
     '../dat/hgt-par-family-rel-raxml-75-regular-hm.daty' using (100):($1-.25):(0):(.5) with vector nohead ls 2

plot '../dat/hgt-par-family-rel-raxml-75-regular-hm.daty' using (100*$2/100):($1):(16):(0.21) with boxxyerrorbars ls 4 fs solid
#white
plot '../dat/hgt-par-family-rel-raxml-75-regular-hm.daty' using (100*$3/100):($1):(16):(0.21) with boxxyerrorbars ls 5 fs solid
...
plot '../dat/hgt-par-family-rel-raxml-75-regular-hm.datx' using ($1):(0):(0):(100) with vector nohead ls 1 , \
     '../dat/hgt-par-family-rel-raxml-75-regular-hm.datx' using ($1-.25):(0):(.5):(0) with vector nohead ls 2, \
     '../dat/hgt-par-family-rel-raxml-75-regular-hm.datx' using ($1-.25):(100):(.5):(0) with vector nohead ls 2


plot '../dat/hgt-par-family-rel-raxml-75-regular-hm.datx' using ($1):(100*$2/100):(0.21):(16) with boxxyerrorbars ls 4 fs solid
#white
plot '../dat/hgt-par-family-rel-raxml-75-regular-hm.datx' using ($1):(100*$3/100):(0.21):(16) with boxxyerrorbars ls 5 fs solid
