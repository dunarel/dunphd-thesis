...
where PROK_GROUP_SOURCE_ID in (86,87,88,89) and 
      PROK_GROUP_DEST_ID in (86,87,88,89)
")
...
select cnt_rel 
from hgt_par_transfer_groups
where PROK_GROUP_SOURCE_ID in (90,91,92,93) and 
      PROK_GROUP_DEST_ID in (90,91,92,93)
")
...
#test = wilcox.test(host_host$CNT_REL,envir_envir$CNT_REL, mu=0, alt="l")
